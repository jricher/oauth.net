...
$languages['python'] = [
  ...
  'client_libraries' => [
    ...
    '<a href="https://github.com/requests/requests-oauthlib">Requests-OAuthlib</a> has OAuth library support for <a href="http://python-requests.org">Python Requests</a>.',
  ],
];
